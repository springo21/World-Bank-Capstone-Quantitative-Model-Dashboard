...
src/
  ...
  heckman.py     # Stage 2: Heckman-based capacity scoring (primary)
  capacity.py    # Stage 2 fallback: rule-based scoring (--skip-heckman)
  build_panel.py # Builds data/raw/heckman_panel.csv (used by heckman.py)
  report.py      # Stage 3: merge, rank, produce charts
